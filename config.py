...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "7301253968:AAESTf4DwkiaLJzlIbOQRh8rNdIHcPlw_aw")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "URLsUploaderBot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "25923579"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "77a03481542a0175aaa33cfabfd38604")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "841851780")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://MyselfNeon:Casper02an@clusterneon.uuwmw.mongodb.net/?retryWrites=true&w=majority&appName=ClusterNeon")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002330072423")) # your log channel id and make bot admin in log channel with full right 
